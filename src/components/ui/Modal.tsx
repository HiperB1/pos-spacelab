...
export function Modal({ show, onClose, title, children, size = 'md', showCloseButton = true }: ModalProps) {
  ...
  const content = (
    ...
    >
      <div className={`w-full ${sizes[size]} mx-4 bg-background border border-white/5 rounded-3xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]`}>
